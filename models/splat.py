...
__all__ = ['SplAtConv2d', 'DropBlock2D','conv2','SplAtConv1d']
...
class SplAtConv2d(Module):
    ...
    def forward(self, x):
        ...
        batch, rchannel = x.shape[:2] # channels*radix
        if self.radix > 1:
...
class conv2(nn.Module):
    def __init__(self, in_channels, channels, kernel_size, stride=(1, 1), padding=(0, 0),
                 dilation=(1, 1), groups=1, bias=True,
                 radix=2, norm_layer=None,
                 dropblock_prob=0.0, **kwargs):
        super().__init__()
        self.conv =nn.Conv2d(in_channels, channels, kernel_size, stride=stride, padding=padding,
